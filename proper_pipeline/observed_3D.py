...
#import QSO_paulo_lumin as paulo_lumin
import pixel as pix
import lya_convertor as convertor
#import theory_P_lyas as theory
...
class observed_3D(object):
    ...
    """ Important redshifts for the cross-correlation:
        lmin = 3501. + 200. * 10 -> z_mean = 3.61
        lmin = 3501. + 200. * 11 -> z_mean = 3.77
        lmin = 3501. + 200. * 12 -> z_mean = 3.94 """
        
    """
        I need to think if I want to modify the total P to ignore the spectrograph performance term, which maskes very little difference, mainly to have the same kind of formalism as Eq. 5.5 from Carucci 2016.
...
#        self.kp_w_kms = 0.01
        ...
        # get the other guys
        # luminosity function
        """Right now luminosity function has two options either load DESI's or paulo's not anymore"""
...
#        self.QLF = paulo_lumin.QSO_LF()
        # spectrograph
        print('*********************** \n')
        print('CAREFUL, CHECK THAT YOU ARE NOT USING THE NEW DATA THAT USES THE NEW PIXEL CLASS')
        print('*********************** \n')
        self.my_pix = pix.spec_pixel(self.band) # this is the original one
#        self.my_pix = pix_new.spec_pixel(self.band) # this uses the new one form 2020 ish.
        # convertor
...
#        print('The mu in the nomu = ',mu)
#        print('The mag k in Mpc in the nomu =',k_Mpc)
#        print('kp_Mpc in the nomu = ',kp_Mpc)
#        print('kt_Mpc in the nomu = ',kt_Mpc)
#        print('The z in the nomu =',z)
#        print('The dkms_dMpc in the nomu =',dkms_dMpc)
#        print('The dMpc_ddeg in the nomu =',dMpc_ddeg)
        # get power in Mpc. We will add reionization next
        P_Mpc = self.my_P.LyaLya_base_Mpc_norm(z,k_Mpc,mu)
        # for testing
#        print('no reio, P3D = ', P_Mpc)
#        print('z = ',z)
#        print('kp_kms = ',kp_kms)
#        print('kt_deg = ',kt_deg)
#        print('dkms_dMpc = ',dkms_dMpc)
#        print('kp_Mpc = ',kp_Mpc)
#        print('dMpc_ddeg = ',dMpc_ddeg)
#        print('kt_Mpc = ',kt_Mpc)
#        print('k_Mpc = ',k_Mpc)
#        print('mu = ',mu)
#        print('P_Mpc = ',P_Mpc)
