...
for z in z_bin:
    ...
    for k, dk in zip(k_bin, dk_bin):
        for mu in mu_bin:
            ...
            one_bin = np.zeros(5)
            one_bin[0] = wdm_3keV_s8.Total_P_21_Mpc_norm(z, k, mu)
            one_bin[1] = wdm_4keV_s8.Total_P_21_Mpc_norm(z, k, mu)
            one_bin[2] = wdm_6keV_s8.Total_P_21_Mpc_norm(z, k, mu)
            one_bin[3] = wdm_9keV_s8.Total_P_21_Mpc_norm(z, k, mu)
            one_bin[4] = cdm_s8.Total_P_21_Mpc_norm(z, k, mu)
