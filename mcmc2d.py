...
wdm_3keV_splus = theory.theory_P_lyas(3.0, '21cm_wdm3_s8plus_r1', 'gadget_sigma+0.05_ave_3keV')
wdm_4keV_splus = theory.theory_P_lyas(4.0, '21cm_wdm4_s8plus_r1', 'gadget_sigma+0.05_ave_4keV')
wdm_6keV_splus = theory.theory_P_lyas(6.0, '21cm_wdm6_s8plus_r1', 'gadget_sigma+0.05_ave_6keV')
wdm_9keV_splus = theory.theory_P_lyas(9.0, '21cm_wdm9_s8plus_r1', 'gadget_sigma+0.05_ave_9keV')
cdm_splus = theory.theory_P_lyas(np.infty, '21cm_cdm_s8plus_r1', 'gadget_sigma+0.05_ave_cdm')
wdm_3keV_sminus = theory.theory_P_lyas(3.0, '21cm_wdm3_s8minus_r1', 'gadget_sigma-0.05_ave_3keV')
wdm_4keV_sminus = theory.theory_P_lyas(4.0, '21cm_wdm4_s8minus_r1', 'gadget_sigma-0.05_ave_4keV')
wdm_6keV_sminus = theory.theory_P_lyas(6.0, '21cm_wdm6_s8minus_r1', 'gadget_sigma-0.05_ave_6keV')
wdm_9keV_sminus = theory.theory_P_lyas(9.0, '21cm_wdm9_s8minus_r1', 'gadget_sigma-0.05_ave_9keV')
cdm_sminus = theory.theory_P_lyas(np.infty, '21cm_cdm_s8minus_r1', 'gadget_sigma-0.05_ave_cdm')
