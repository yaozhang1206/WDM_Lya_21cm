...
z, k, cross_r1_cdm = np.loadtxt('./data/21cmFAST/cross_21cm_r1_cdm.txt', unpack=True)
z, k, cross_r2_cdm = np.loadtxt('./data/21cmFAST/cross_21cm_r2_cdm.txt', unpack=True)
z, k, cross_r3_cdm = np.loadtxt('./data/21cmFAST/cross_21cm_r3_cdm.txt', unpack=True)
z, k, cross_r4_cdm = np.loadtxt('./data/21cmFAST/cross_21cm_r4_cdm.txt', unpack=True)
# 3keV
z, k, cross_r1_3keV = np.loadtxt('./data/21cmFAST/cross_21cm_r1_wdm3.txt', unpack=True)
z, k, cross_r2_3keV = np.loadtxt('./data/21cmFAST/cross_21cm_r2_wdm3.txt', unpack=True)
z, k, cross_r3_3keV = np.loadtxt('./data/21cmFAST/cross_21cm_r3_wdm3.txt', unpack=True)
z, k, cross_r4_3keV = np.loadtxt('./data/21cmFAST/cross_21cm_r4_wdm3.txt', unpack=True)
# 4keV
z, k, cross_r1_4keV = np.loadtxt('./data/21cmFAST/cross_21cm_r1_wdm4.txt', unpack=True)
z, k, cross_r2_4keV = np.loadtxt('./data/21cmFAST/cross_21cm_r2_wdm4.txt', unpack=True)
z, k, cross_r3_4keV = np.loadtxt('./data/21cmFAST/cross_21cm_r3_wdm4.txt', unpack=True)
z, k, cross_r4_4keV = np.loadtxt('./data/21cmFAST/cross_21cm_r4_wdm4.txt', unpack=True)
# 6keV
z, k, cross_r1_6keV = np.loadtxt('./data/21cmFAST/cross_21cm_r1_wdm6.txt', unpack=True)
z, k, cross_r2_6keV = np.loadtxt('./data/21cmFAST/cross_21cm_r2_wdm6.txt', unpack=True)
z, k, cross_r3_6keV = np.loadtxt('./data/21cmFAST/cross_21cm_r3_wdm6.txt', unpack=True)
z, k, cross_r4_6keV = np.loadtxt('./data/21cmFAST/cross_21cm_r4_wdm6.txt', unpack=True)
# 9keV
z, k, cross_r1_9keV = np.loadtxt('./data/21cmFAST/cross_21cm_r1_wdm9.txt', unpack=True)
z, k, cross_r2_9keV = np.loadtxt('./data/21cmFAST/cross_21cm_r2_wdm9.txt', unpack=True)
z, k, cross_r3_9keV = np.loadtxt('./data/21cmFAST/cross_21cm_r3_wdm9.txt', unpack=True)
z, k, cross_r4_9keV = np.loadtxt('./data/21cmFAST/cross_21cm_r4_wdm9.txt', unpack=True)
z = np.unique(z)
k = np.unique(k)
