...
plt.savefig("xh_box_r2_cdm_15_8_2022.png",dpi=200)
...
file_new.to_csv('z_and_xH_values_r2_cdm_15_8_2022',sep=' ',header=False ,index=False)
...
# file_new.to_csv('results_k_mh_fid_2',index=False)
# new2 = file_new2.style.hide_index()
# file_new2.to_csv('results_pm_mh_fid_2',index=False)
# new3 = file_new3.style.hide_index()
# file_new3.to_csv('redshift_mh_fid_2',index=False)
...
file_new4.to_csv('cross_21cm_r2_cdm_14_8_2022',sep=' ',header=False ,index=False)
...
file_new5.to_csv('cross_21cm_r2_cdm_15_8_2022_sn',sep=' ',header=False ,index=False)
