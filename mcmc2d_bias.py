...
axs[0].set_ylabel(r'$1\ \rm{keV}\ /\ m_{\rm{X}}$', fontsize=16)
axs[1].plot(range(len(samples1)), samples1[:, :, 1], "k", alpha=0.3)
axs[1].set_xlabel('step number', fontsize=16)
axs[1].set_ylabel(r'$\sigma_8$', fontsize=16)
...
samples = sampler.get_chain(flat=True, discard=4000, thin=60)
fig1 = corner.corner(
    samples, labels=[r'$1\ \rm{keV}\ /\ m_{\rm{X}}$', r'$\sigma_8$'], truths=[0, 0.8159],
