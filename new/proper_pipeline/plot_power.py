...
for i in range(2):
    ...
    axs[0,i].grid(linestyle='dotted')
    axs[1,i].grid(linestyle='dotted')
    ...
    axs[i,1].set_ylabel(r'$P_{21}\;\;{\rm [mK^2\;Mpc^3]}$', fontsize=16)

left00, bottom00, width00, height00 = 0.26, 0.72, 0.21, 0.21
...
small_00.grid(linestyle='dotted')

left01, bottom01, width01, height01 = 0.76, 0.72, 0.21, 0.21
...
small_01.grid(linestyle='dotted')

left10, bottom10, width10, height10 = 0.26, 0.265, 0.21, 0.21
...
small_10.grid(linestyle='dotted')

left11, bottom11, width11, height11 = 0.76, 0.265, 0.21, 0.21
...
small_11.grid(linestyle='dotted')

axs[0,0].set_title(r'${\rm Ly}\alpha$'+' forest power spectrum\nRedshift=4.0', fontsize=14)
axs[0,1].set_title('21 cm IM power spectrum\nRedshift=5.5', fontsize=14)
axs[1,0].set_title(r'Redshift=2.0', fontsize=14)
axs[1,1].set_title(r'Redshift=3.5', fontsize=14)
...
fig.tight_layout()
fig.savefig('power_spectrum.pdf')
