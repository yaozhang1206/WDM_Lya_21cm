...
print(kbin)
for i in range(2):
    print('conventional CDM for lya:')
    print(cdm_norm_lya[i])
    print('conventional CDM for 21cm:')
    print(cdm_norm_21[i])
    for j in range(5):
        print('z=%.1f, lya'%zbin_lya[i])
        for j in range(5):
            print(models[j])
            print(data_lya[j,0,i,:])
            if j>0:
                print(frac_lya[j-1,0,i,:])
    for j in range(5):
        print('z=%.1f, 21 cm'%zbin_21[i])
        for j in range(5):
            print(models[j])
            print(data_21[j,0,i,:])
            if j>0:
                print(frac_21[j-1,0,i,:])
...
for i in range(2):
    for j in range(5):
        axs[i,0].plot(kbin, data_lya[j,0,i,:], c=colors[j], label=labels[j], linewidth=lw)
        axs[i,1].plot(kbin, data_21[j,0,i,:], c=colors[j], label=labels[j], linewidth=lw)
        axs[i,0].fill_between(kbin, data_lya[j,0,i,:]-error_lya[j,i,:], data_lya[j,0,i,:]+error_lya[j,i,:],facecolor=colors[j], edgecolor=None, alpha=0.3)
        axs[i,1].fill_between(kbin, data_21[j,0,i,:]-error_21[j,i,:], data_21[j,0,i,:]+error_21[j,i,:],facecolor=colors[j], edgecolor=None, alpha=0.3)
        axs[i,0].plot(kbin, cdm_norm_lya[i], c=colors[0], ls='--',linewidth=lw)
        axs[i,1].plot(kbin, cdm_norm_21[i], c=colors[0], ls='--',linewidth=lw)



    axs[0,i].set_xscale('log')
    axs[0,i].set_xlim(0.05, 0.5)
    axs[1,i].set_xscale('log')
    axs[1,i].set_xlim(0.05, 0.5)
...
for j in [1,2,3,4]:
    small_00.plot(kbin, frac_lya[j-1,0,0,:], c=colors[j], linewidth=lw)
    small_00.fill_between(kbin, frac_lya[j-1,0,0,:]-frac_err_lya[j-1,0,:], frac_lya[j-1,0,0,:]+frac_err_lya[j-1,0,:],facecolor=colors[j], edgecolor=None, alpha=0.3)
small_00.set_xlim(0.05, 0.5)
...
small_00.xaxis.set_major_formatter(FormatStrFormatter('%.2f'))

left01, bottom01, width01, height01 = 0.76, 0.715, 0.21, 0.21
small_01 = fig.add_axes([left01, bottom01, width01, height01])
for j in [1,2,3,4]:
    small_01.plot(kbin, frac_21[j-1,0,0,:], c=colors[j], linewidth=lw)
    small_01.fill_between(kbin, frac_21[j-1,0,0,:]-frac_err_21[j-1,0,:], frac_21[j-1,0,0,:]+frac_err_21[j-1,0,:],facecolor=colors[j], edgecolor=None, alpha=0.3)
small_01.set_xlim(0.05, 0.5)
...
small_01.xaxis.set_major_formatter(FormatStrFormatter('%.2f'))

left10, bottom10, width10, height10 = 0.26, 0.263, 0.21, 0.21
small_10 = fig.add_axes([left10, bottom10, width10, height10])
for j in [1,2,3,4]:
    small_10.plot(kbin, frac_lya[j-1,0,1,:],c=colors[j],linewidth=lw)
    small_10.fill_between(kbin, frac_lya[j-1,0,1,:]-frac_err_lya[j-1,1,:], frac_lya[j-1,0,1,:]+frac_err_lya[j-1,1,:],facecolor=colors[j], edgecolor=None, alpha=0.3)
small_10.set_xlim(0.05, 0.5)
...
small_10.xaxis.set_major_formatter(FormatStrFormatter('%.2f'))

left11, bottom11, width11, height11 = 0.76, 0.263, 0.21, 0.21
small_11 = fig.add_axes([left11, bottom11, width11, height11])
for j in [1,2,3,4]:
    small_11.plot(kbin, frac_21[j-1,0,1,:],c=colors[j],linewidth=lw)
    small_11.fill_between(kbin, frac_21[j-1,0,1,:]-frac_err_21[j-1,1,:], frac_21[j-1,0,1,:]+frac_err_21[j-1,1,:],facecolor=colors[j], edgecolor=None, alpha=0.3)
small_11.set_xlim(0.05, 0.5)
...
small_11.xaxis.set_major_formatter(FormatStrFormatter('%.2f'))
...
axs[0,0].legend(loc='lower right',fontsize=10, bbox_to_anchor=(0.985,0.07))
fig.tight_layout()
fig.savefig('power_spectrum_v3.pdf')
