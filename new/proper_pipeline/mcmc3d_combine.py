...
zeta_p1_21 = theory_21.theory_P_cross(params)
...
zeta_p2_21 = theory_21.theory_P_cross(params)
...
zeta_p3_21 = theory_21.theory_P_cross(params)
...
zeta_p4_21 = theory_21.theory_P_cross(params)
...
zeta_p5_21 = theory_21.theory_P_cross(params)
...
bins_lya = np.zeros((len(z_bin_lya)*len(k_bin_lya)*len(mu_bin_lya), 20))
i = 0
for z in z_bin_lya:
    for k in k_bin_lya:
...
# run mcmc chain
filename = "chain_combine_%s_zeta_f.h5"%(tele)
